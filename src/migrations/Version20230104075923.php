 ...
 */
final class Version20230104075923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD COLUMN password VARCHAR(255) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__personne AS SELECT id, etudiant_id, enseignant_id, email, nom, prenom FROM personne');
        ...
        $this->addSql('INSERT INTO personne (id, etudiant_id, enseignant_id, email, nom, prenom) SELECT id, etudiant_id, enseignant_id, email, nom, prenom FROM __temp__personne');
